...
body {
    ...
    margin: 0; /* Remove these lines as they are not needed */
    padding: 0; /* Remove these lines as they are not needed */
    background: url(Airplane.gif) no-repeat top center #efeff1;
    background-size: 100% 100%; /* Cover the entire page with the GIF */
...
.flight-search-form {
    background-color: rgba(255, 255, 255, 0.7); /* Use an RGBA color with an alpha value to make it transparent */
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="vacation">Vacation Packages</a></li>
                <li><a href="contactus">Contact us</a></li>
                <li><a href="feedback">FeedBack</a></li>
                <li><a href="chatbot">ChatWithUs</a></li>
                <li class="user-account">
                        <img src="logo.jpg" alt="Logout" width="42" height="35">
                </li>
            </ul>
        </nav>
